...
class $AssetsSliderGen {
  ...
  /// File path: assets/slider/soccer1.jpeg
  AssetGenImage get soccer1 =>
      const AssetGenImage('assets/slider/soccer1.jpeg');

  /// File path: assets/slider/soccer2.jpg
  AssetGenImage get soccer2 => const AssetGenImage('assets/slider/soccer2.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [soccer1, soccer2];
}
